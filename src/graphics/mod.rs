...
impl Window {
    ...
    pub fn new(width: i32, height: i32, title: String) -> Self {
            ...
            match cstr_ret {
                Ok(cstr) => {
                    ...
                    let err_val =
                        unsafe {af_create_window(&mut temp as *mut af_window, width, height, cstr.as_ptr())};
    ...
    pub fn set_axes_titles(&mut self, xlabel: String, ylabel: String, zlabel: String) {
        ...
        let zstr = CString::new(zlabel).unwrap();
            ...
            let err_val = unsafe {af_set_axes_titles(
                self.handle,
                xstr.as_ptr(),
                ystr.as_ptr(),
                zstr.as_ptr(),
    ...
    pub fn set_axes_label_format(
        ...
        let zstr = CString::new(zlabel_format).unwrap();
            ...
            let err_val = unsafe {af_set_axes_label_format(
                self.handle,
                xstr.as_ptr(),
                ystr.as_ptr(),
                zstr.as_ptr(),
        ...
        T: HasAfEnum,
    {
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_set_axes_limits_compute(
                self.handle,
                xrange.get(),
                yrange.get(),
                match zrange {
    ...
    pub fn set_axes_limits_2d(&mut self, xmin: f32, xmax: f32, ymin: f32, ymax: f32, exact: bool) {
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_set_axes_limits_2d(
                self.handle,
                xmin,
                xmax,
                ymin,
    ...
    pub fn set_axes_limits_3d(
        ...
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_set_axes_limits_3d(
                self.handle,
                xmin,
                xmax,
                ymin,
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val =unsafe { af_draw_plot_2d(self.handle, x.get(), y.get(), &cprops as *const af_cell)};
            HANDLE_ERROR(AfError::from(err_val));
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_draw_plot_nd(self.handle, points.get(), &cprops as *const af_cell)};
            HANDLE_ERROR(AfError::from(err_val));
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val =unsafe { af_draw_hist(
                self.handle,
                hst.get(),
                minval,
                maxval,
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_draw_surface(
                self.handle,
                xvals.get(),
                yvals.get(),
                zvals.get(),
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_draw_scatter_2d(
                self.handle,
                xvals.get(),
                yvals.get(),
                marker as c_uint,
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_draw_scatter_3d(
                self.handle,
                xvals.get(),
                yvals.get(),
                zvals.get(),
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val =unsafe { af_draw_scatter_nd(
                self.handle,
                vals.get(),
                marker as c_uint,
                &cprops as *const af_cell,
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_draw_vector_field_2d(
                self.handle,
                xpnts.get(),
                ypnts.get(),
                xdirs.get(),
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val = unsafe {af_draw_vector_field_3d(
                self.handle,
                xpnts.get(),
                ypnts.get(),
                zpnts.get(),
        ...
        T: HasAfEnum,
    {
        ...
        let cprops = af_cell {
            ...
            let err_val =unsafe { af_draw_vector_field_nd(
                self.handle,
                points.get(),
                directions.get(),
                &cprops as *const af_cell,
